...
export const strings = {
  ...
  payment: {
    ...
    tipSectionLabel: 'BAHŞİŞ',
    tipLabel: 'Bahşiş',
    tipNone: 'Yok',
    tip5: '%5',
    tip10: '%10',
    tip15: '%15',
    tipBreakdown: (pct: number) => `Bahşiş (${pct}%)`,
    cardLabel: 'KART BİLGİSİ',
    cardNumber: 'Kart numarası',
    expiry: 'AA/YY',
    cvc: 'CVC',
    billShare: 'Hesap payı',
    alreadyPaid: 'Hesap zaten ödendi.',
    pay: (amount: string) => `Öde · ${amount}`,
  ...
  result: {
    ...
    fiscalNotice: 'Bu belge mali fiş veya fatura değildir. Resmi fişinizi kasadan alınız.',
    remainingInTable: (amount: string) => `Masada kalan: ${amount}`,
  ...
  admin: {
    ...
    tableDetail: {
      ...
      addItem: 'Kalem Ekle',
      billPanelLabel: 'Adisyon',
      qrPanelLabel: 'QR Kodu',
      qrNoBill: 'Adisyon açıldığında QR burada görünür',
      noBill: '"Adisyon Aç" butonunu kullan.',
      emptyBill: 'Adisyon boş.',
      total: 'Toplam',
      breakdownTotal: 'Hesap toplamı',
      breakdownPaid: 'Ödenen (hesap)',
      breakdownTip: 'Bahşiş',
      breakdownCollected: 'Toplam tahsilat',
      breakdownRemaining: 'Kalan',
      breakdownPayments: 'Ödemeler',
      paymentShareLabel: (n: number) => `#${n} hesap payı`,
      paymentTipLabel: 'bahşiş',
      paymentTotalLabel: 'toplam',
      noBreakdown: 'Adisyon açıldığında döküm burada görünür.',
      paid: 'ödendi',
    },
  },
}
